...
export default function BusinessVerification() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			await axios.post(
				"http://localhost:3000/api/business/verification",
				{
							...
							<div className="mt-8 flex items-center justify-between gap-3">
								...
								{currentStep === 1 ? (
									<button
										type="button"
										onClick={handleNext}
										className="ml-auto inline-flex cursor-pointer items-center justify-center gap-2 rounded-2xl bg-slate-900 px-5 py-3 font-semibold text-white transition hover:bg-slate-800">
										Continue
